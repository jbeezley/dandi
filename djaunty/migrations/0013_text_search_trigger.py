...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djaunty', '0012_dataset_experiment_description'),
    ]

    migration = """
        DROP TRIGGER IF EXISTS djaunty_text_search_trigger ON djaunty_dataset;
        DROP FUNCTION IF EXISTS djaunty_text_search_update;
        ...
        begin
            ...
            NEW.search_vector :=
                ...
                to_tsvector(coalesce(NEW.experiment_description, '')) ||
